...
When drafting or editing blog posts, always apply the `/stop-slop` skill before delivering prose.

## Agent skills

### Issue tracker

Issues live in GitHub Issues for `sushilk1991/mastisk`, via the `gh` CLI. See `docs/agents/issue-tracker.md`.
